// Conexión única al proxy del ecosistema (closer-click-proxy-client). Al conectar
...
const WS_URL = (import.meta.env && import.meta.env.VITE_WS_URL) || 'wss://proxy.closer.click';
